    ...
    navbar: {
      ...
      items: [
        ...
        },
        {
          ...
          position: 'left',
          items: [
            { type: 'docSidebar', sidebarId: 'campaignsSidebar', label: 'Campaigns' },
        ...
        },
        {
          ...
          items: [
            ...
            { type: 'docSidebar', sidebarId: 'leadAssistSidebar', label: 'ExoBridge (Lead Assist) - GreenPin' },
            { type: 'docSidebar', sidebarId: 'leadAssistGreenVnSidebar', label: 'ExoBridge (Lead Assist) - GreenVN' },
            { type: 'docSidebar', sidebarId: 'leadAssistSettingsSidebar', label: 'ExoBridge (Lead Assist) - Settings' },
      ...
      links: [
        {
          ...
          items: [
            ...
            { label: 'Contact Center APIs v6', to: '/docs/contact-center/overview' },
            { label: 'Campaigns', to: '/docs/campaigns/overview' },
            { label: 'SMS Campaigns', to: '/docs/sms-campaigns/overview' },
            { label: 'ExoPhones', to: '/docs/exophones/overview' },
            { label: 'ExoBridge (Lead Assist) - GreenPin', to: '/docs/lead-assist/overview' },
            { label: 'Gen AI', to: '/docs/gen-ai/overview' },
            { label: 'Legs', to: '/docs/legs/overview' },
          ],
        },
        {
          title: 'Resources',
