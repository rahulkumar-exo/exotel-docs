...
const sidebars: SidebarsConfig = {
  ...
  // ✨ New Products — autogenerated so any new product PMs add via the
  // "✨ Add New Product Documentation" CMS collection auto-appears in
  // this sidebar without engineering. Each product folder under
  // docs/new-products/<slug>/ becomes its own collapsible section.
  newProductsSidebar: [
    {
      type: 'autogenerated',
      dirName: 'new-products',
    },
  ],
};
