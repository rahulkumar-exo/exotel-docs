...
const sidebars: SidebarsConfig = {
  ...
  // CQA — Conversation Quality Analysis
  cqaSidebar: [
    {
      type: 'autogenerated',
      dirName: 'cqa',
  ...
  // (newProductsSidebar removed — the public-facing /docs/new-products/
  // overview page is gone. PMs can still scaffold brand-new products via
  // the CMS "✨ NEW: Add a brand-new product" collection; the resulting
  // pages are reachable by direct URL but no longer pollute the navbar
  // until an engineer graduates them to a top-level collection.)
};
