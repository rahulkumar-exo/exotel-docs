...
<ApiConsole
  ...
  description="List all processes in a contact center"
  params={[
    { name: 'contactCenterId', in: 'path', type: 'string', required: true, description: 'Contact center ID' },
    { name: 'limit', in: 'query', type: 'string', required: false, description: 'Records per page (max 10)' },
    { name: 'offset', in: 'query', type: 'string', required: false, description: 'Pagination offset' },
    { name: 'sort_by', in: 'query', type: 'string', required: false, description: 'Sort criteria (e.g., id:desc)' },
    { name: 'processName', in: 'query', type: 'string', required: false, description: 'Filter by process name prefix' },
  ]}
/>
