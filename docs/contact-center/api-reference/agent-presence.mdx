...
<TryItBanner method="GET" endpoint="/v2/accounts/{sid}/agents/presence" />
...
<ApiConsole
  method="GET"
  path="/v2/accounts/{account_sid}/agents/presence"
  contentType="json"
  params={[
    { name: 'status', required: false, type: 'string', description: 'Filter by agent status: available, busy, on-call, offline, after-call-work', placeholder: 'available' },
    { name: 'team_id', required: false, type: 'string', description: 'Filter by team', placeholder: 'sales_team' },
    { name: 'limit', required: false, type: 'number', description: 'Results per page (default: 20, max: 100)', placeholder: '20' },
