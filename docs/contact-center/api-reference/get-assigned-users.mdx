...
<ApiConsole
  ...
  description="Get assigned users for a lead"
  params={[
    { name: 'contactCenterId', in: 'path', type: 'string', required: true, description: 'Contact center ID' },
    { name: 'processId', in: 'path', type: 'string', required: true, description: 'Process ID' },
    { name: 'campaignId', in: 'path', type: 'string', required: true, description: 'Campaign ID' },
    { name: 'leadId', in: 'query', type: 'string', required: true, description: 'Lead ID' },
    { name: 'limit', in: 'query', type: 'string', required: true, description: 'Number of records' },
    { name: 'offset', in: 'query', type: 'string', required: true, description: 'Pagination offset' },
  ]}
/>
