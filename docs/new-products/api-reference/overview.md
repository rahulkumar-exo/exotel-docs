---
title: CQA
id: cqa-api-reference-guide
description: Documentation pages for products being scaffolded by Product
  Managers via the CMS, before they graduate to dedicated top-level collections.
sidebar_label: CQA
