...
id: voicelogs
title: Voicelogs
description: Retrieve voice call logs, recordings, and analytics for Exotel Contact Center v4 calls. Filter by agent, direction, status, and date range.
...
<TryItBanner method="GET" endpoint="/v4/accounts/{sid}/voicelogs" />
...
<ApiConsole
  method="GET"
  path="/v4/accounts/{account_sid}/voicelogs"
  contentType="json"
  params={[
    { name: 'start_time', required: false, type: 'string', description: 'Start of time range (ISO 8601)', placeholder: '2024-06-01T00:00:00Z' },
    { name: 'end_time', required: false, type: 'string', description: 'End of time range (ISO 8601)', placeholder: '2024-06-30T23:59:59Z' },
    { name: 'agent_id', required: false, type: 'string', description: 'Filter by agent', placeholder: 'agent_001' },
    { name: 'direction', required: false, type: 'string', description: 'inbound or outbound', placeholder: 'outbound' },
    { name: 'status', required: false, type: 'string', description: 'completed, missed, or abandoned', placeholder: 'completed' },
    { name: 'limit', required: false, type: 'number', description: 'Results per page (default: 20, max: 100)', placeholder: '50' },
    { name: 'offset', required: false, type: 'number', description: 'Pagination offset', placeholder: '0' },
  ]}
/>
