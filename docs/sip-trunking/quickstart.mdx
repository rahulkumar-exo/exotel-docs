...
<ApiConsole
  ...
  host="api"
  params={[
    { name: 'trunk_name', required: true, type: 'string', description: 'Alphanumeric + underscores, max 16 chars', defaultValue: 'my_trunk', placeholder: 'my_trunk' },
...
<ApiConsole
  ...
  params={[
    ...
    { name: 'mode', required: false, type: 'string', description: 'pstn (default) or flow', defaultValue: 'pstn', placeholder: 'pstn' },
  ]}
/>
...
<ApiConsole
  ...
  params={[
    ...
    { name: 'ip', required: true, type: 'string', description: 'Your public IPv4', placeholder: '44.248.146.11' },
...
<ApiConsole
  ...
  params={[
    { name: 'trunk_sid', required: true, type: 'string', description: 'Trunk SID', placeholder: 'trmum...' },
    { name: 'user_name', required: true, type: 'string', description: 'SIP digest username', defaultValue: 'SIP_USER', placeholder: 'SIP_USER' },
...
<ApiConsole
  ...
  params={[
    { name: 'trunk_sid', required: true, type: 'string', description: 'Trunk SID', placeholder: 'trmum...' },
    { name: 'destinations', required: true, type: 'string', description: 'JSON array of destination objects', defaultValue: '[{"destination":"sip.yourcompany.com:5061;transport=tls"}]', placeholder: '[{"destination":"44.248.146.11:5061;transport=tls"}]' },
  ]}
/>
