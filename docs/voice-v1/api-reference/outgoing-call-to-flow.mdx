...
:::note
This is the same request as [Connect Number to Call Flow](/docs/voice-v1/api-reference/connect-to-flow). Use that page.
:::
...
func main() {
    ...
    data := url.Values{}
    data.Set("From", "09876543210")
    data.Set("CallerId", "0XXXXXX4890")
    data.Set("Url", "http://my.exotel.com/<your_sid>/exoml/start_voice/926")
...
<ApiConsole
  ...
  params={[
    ...
    { name: 'Url', required: true, type: 'string', description: 'Call flow URL: http://my.exotel.com/{account_sid}/exoml/start_voice/{app_id}', placeholder: 'http://my.exotel.com/your_sid/exoml/start_voice/926' },
