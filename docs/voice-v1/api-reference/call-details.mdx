...
<TryItBanner method="GET" endpoint="/v1/Accounts/{sid}/Calls/{CallSid}" />

## Single Call Details

<RegionalUrls path="/v1/Accounts/{sid}/Calls/{CallSid}.json" host="api" />
...
<RegionalUrls path="/v1/Accounts/{sid}/Calls.json" host="api" />
...
<ApiConsole
  method="GET"
  path="/v1/Accounts/{account_sid}/Calls/{CallSid}.json"
  params={[
    { name: 'CallSid', required: true, type: 'string', description: 'Unique call identifier (replaces {CallSid} in URL)', placeholder: 'c5797dcbaaeed7678c4062a4a3ed2f8a' },
