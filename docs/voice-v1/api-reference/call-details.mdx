...
description: "Get call details, bulk call logs, number metadata, and status callback webhooks via Exotel Voice API."
id: call-details
...
<ApiConsole
  ...
  params={[
    { name: 'phone_number', required: true, type: 'string', description: 'Indian phone number (replaces {phone_number} in URL)', placeholder: '09876543210' },
  ]}
/>
