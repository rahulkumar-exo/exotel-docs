...
| `TimeOut` | Integer | — | Time in seconds to ring the called parties (both the From and To legs). The timer runs only during ringing and stops once each leg is answered. Default: 30 seconds. |
