...
:::info
This is a **CCM** (Contact Center Management) API. Use it for calls placed with [Connect Agent to Customer](/docs/voice-api/api-reference/make-a-call) if you run contact center operations on `my*.exotel.com`. For calls that connect two phone numbers, see [Call Details](/docs/voice-v1/api-reference/call-details).
:::
...
| `call_sid` | String | Unique call identifier from the [Connect Agent to Customer](/docs/voice-api/api-reference/make-a-call) response |
