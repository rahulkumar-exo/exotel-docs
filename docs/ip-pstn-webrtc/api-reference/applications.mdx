...
description: Register, retrieve, list, and delete WebRTC calling applications using the Exotel IP-PSTN Application Management API.
...
<TryItBanner method="POST" endpoint="/v2/integrations/app" />
...
```javascript
const url = 'https://integrationscore.mum1.exotel.com/v2/integrations/app';
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://integrationscore.mum1.exotel.com/v2/integrations/app',
  ...
  CURLOPT_HTTPHEADER => array(
    'Authorization: NmUxNGIyN2ItY2YzYy00MzRhLThlNzItYWNjMWFiNWQzY2Vi',
    'Content-Type: application/json'
  ),
));
...
func main() {
   ...
   "IsActive": true
    ...
    req.Header.Add("Authorization", "NmUxNGIyN2ItY2YzYy00MzRhLThlNzItYWNjMWFiNWQzY2Vi")
...
```javascript
const url = 'https://integrationscore.mum1.exotel.com/v2/integrations/app?entity=app';
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://integrationscore.mum1.exotel.com/v2/integrations/app?entity=app',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_HTTPHEADER => array(
    'Authorization: <app_auth_token>'
  ),
...
func main() {
    ...
    req.Header.Add("Authorization", "<app_auth_token>")
...
url = "https://integrationscore.mum1.exotel.com/v2/integrations/app?entity=customer"
...
```javascript
const url = 'https://integrationscore.mum1.exotel.com/v2/integrations/app?entity=customer';
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://integrationscore.mum1.exotel.com/v2/integrations/app?entity=customer',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_HTTPHEADER => array(
    'Authorization: <customer_auth_token>'
  ),
...
func main() {
    ...
    req, _ := http.NewRequest("GET", url, nil)
    req.Header.Add("Authorization", "<customer_auth_token>")
...
<ApiConsole
  method="POST"
  path="/v2/integrations/app"
  contentType="json"
  params={[
    { name: 'AppName', required: true, type: 'string', description: 'Name for the application', placeholder: 'WebRTC' },
    { name: 'ExotelAccountSid', required: true, type: 'string', description: 'Your Exotel Account SID', placeholder: 'exoteldemo' },
    { name: 'ExotelApiKey', required: true, type: 'string', description: 'Your Exotel API key', placeholder: 'your_api_key' },
    { name: 'ExotelApiToken', required: true, type: 'string', description: 'Your Exotel API token', placeholder: 'your_api_token' },
    { name: 'ExotelDomain', required: true, type: 'string', description: 'Region domain: mumbai or singapore', placeholder: 'mumbai' },
    { name: 'IsActive', required: true, type: 'boolean', description: 'Set to true to enable the app for calling' },
  ]}
/>
