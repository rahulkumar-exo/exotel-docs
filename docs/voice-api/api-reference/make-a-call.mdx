...
<TryItBanner method="POST" endpoint="/v2/accounts/{account_sid}/calls" />
...
<RegionalUrls path="/v2/accounts/{account_sid}/calls" host="ccm" />
...
<ApiConsole
  method="POST"
  path="/v2/accounts/{account_sid}/calls"
  contentType="json"
  host="ccm"
  params={[
