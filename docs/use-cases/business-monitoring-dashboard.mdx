...
description: Build a real-time business monitoring dashboard using Exotel Bulk Call Details and Heartbeat APIs to track call metrics and ExoPhone health.
sidebar_position: 1
---
